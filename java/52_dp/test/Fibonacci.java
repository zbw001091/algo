...
//		long result = f.f_recursive(number);
		...
		long millis = (l - day * 24 * 60 * 60 * 1000 - hour * 60 * 60 * 1000 - min * 60 * 1000);
...
//		System.out.println("result = " + result);
		...
		long millis2 = (l2 - day2 * 24 * 60 * 60 * 1000 - hour2 * 60 * 60 * 1000 - min2 * 60 * 1000);
...
//		}
		...
		long millis3 = (l3 - day3 * 24 * 60 * 60 * 1000 - hour3 * 60 * 60 * 1000 - min3 * 60 * 1000);
